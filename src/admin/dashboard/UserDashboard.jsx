            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                    ...
                    <tr className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-6 text-left">Apple Sticker</td>
                        <td className="py-3 px-6 text-left">Colombo</td>
                        <td className="py-3 px-6 text-left">Qty</td>
                        <td className="py-3 px-6 text-left">6-5-25</td>
                        <td className="py-3 px-6 text-left">Printing</td>
