...
function CardComponent({ id, title,size, description, price, image, status, category, qty }) {
  const navigate = useNavigate();


    console.log('CardComponent props:', { id, title, size, description, price, image, status, category, qty });
  ...
  return (
    <div className="w-full max-w-sm h-[480px] flex flex-col justify-between rounded-lg overflow-hidden shadow-md bg-white">
      ...
      <div className="p-4 flex flex-col flex-grow justify-between">
        ...
        <p className="text-gray-600 text-sm mt-1 line-clamp-2">{size}</p>
